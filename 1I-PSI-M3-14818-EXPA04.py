...
def main():
    ...
    while True:
        ...
        print("5. Exportar para um ficheiro")
        print("6. Sair")
        ...
        if opcao == "1":
            ...
            ficheiro = input("Em qual ficheiro quer guardar?: ").lower()
            print(f'Guardado no ficheiro {ficheiro}')
            print("A exportar para um ficheiro..")
        elif opcao == "6":
